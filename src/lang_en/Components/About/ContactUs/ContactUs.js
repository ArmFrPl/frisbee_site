  ...
  render(){
    return (
      <div className="ContactUs">
        ...
        <h2 className="heading2">In Social Media</h2>
        <div className="socMed">
          <p>
            <a className="links" target='_blank' rel='noopener noreferrer' href="https://www.facebook.com/Armfrisbee/">Facebook</a>
          </p>
          <p>
            <a className="links" target='_blank' rel='noopener noreferrer' href="https://www.instagram.com/ultimate_armenia/">Instagram</a>
          </p>
          <p>
            <a className="links" target='_blank' rel='noopener noreferrer' href="https://www.youtube.com/channel/UCP3G6qKYG3z1gGaGU-jKGNw">Youtube</a>
          </p>
        </div>
      </div>
    );
